...
namespace OCSMarkingDLL
{
    ...
    {
        public static String Version = "V0.1.8";
        ...
        private static String customs1 = "COUNTRY OF ORIGIN MALAYSIA";
        //private static String customs2 = "MALAYSIA";

        private static string PREIVIEW_STR = "";
        private static string PREIVIEW_STR_4_HEADER = "";
            ...
            string old_material_number, string serial_num,  string customs, string thread1, string thread2)
        {
            ...
            Console.WriteLine("char_size="+ char_size + ", marking_locationX="+ marking_locationX + ", partDia="+ partDia + ", material_num="+ material_num);
            ...
            PREIVIEW_STR_4_HEADER = GetMarkingPreview4Header(char_size, bu, marking_locationX, partDia, material_num, old_material_number, serial_num, thread1, thread2); ;
            PREIVIEW_STR = GetMarkingPreview(char_size, bu, marking_locationX, partDia, material_num, old_material_number, serial_num, thread1, thread2);
            ...
            //remove location and dia
             res =  doGenerateGC(char_size, material_num, old_material_number, serial_num, customs,  thread1,  thread2);                     
         ...
         * Getting Preview
         */
        public static String GetMarkingPreview(string char_size, string bu, double marking_locationX, double partDia, string material_num,
        ...
        {           
            ...
            int customs_len = customs1.Length;
                ...
                ///remove marking location and part dia / output no need to location
              marking_final_output = (material_num + NL + old_material_number + NL + serial_num +  NL);
             
             //   marking_final_output = (material_num + NL + old_material_number + NL + serial_num + NL + marking_locationX + NL + partDia + NL);
                      
            
            line1_len = (material_num).Length;
                line2_len = old_material_number.Length;
                line3_len = serial_num.Length;


                //customs comes before Thread info
                marking_final_output = marking_final_output + customs1;
            ...
            marking_final_output = marking_final_output + NL + NL + "LONGEST LINE LENGTH : " + final_size.ToString("0.#") + " INCHES";
        ...
        * Getting Preview
        */
        public static String GetMarkingPreview4Header(string char_size, string bu, double marking_locationX, double partDia, string material_num,
           string old_material_number, string serial_num, string thread1, string thread2)
        {
            ...
            ///remove marking location and part dia
             //marking_final_output = (material_num + NL + old_material_number + NL + serial_num +  NL);
            ...
            //customs comes before Thread info
            marking_final_output = marking_final_output + NL + customs1;
        ...
        private static String doGenerateGC( string char_size, string partnum,
            string old_material_number, string serial_num,   string customs, string thread1, string thread2)
        {
            ...
            string v_customs = "COUNTRY OF ORIGIN MALAYSIA";
           
            string v_thread_1 = thread1;
            string v_thread_2 = thread2;
            string final_batch = serial_num;// + v_drw_rev;
            ...
            //customs before Thread
            eia_final_output = eia_final_output + getProgram(NEW_LINE) + getProgram(v_customs);
            ...
            eia_final_output = eia_final_output +   getProgram(">");
            ...
            string old_material_number, string serial_num,   string customs, string thread1, string thread2)
        {
           ...
           // string v_drw_rev = "-" + drawing_rev;
            ...
            eia_final_output = eia_final_output + getProgram(NEW_LINE) + getProgram(v_customs) +  getProgram(">");
            return eia_final_output;
        }
        /**
      * P : Production Order
      ...
      */
        ...
        private static void readValFromDB(string machine, string size)
        {
            if (size.Equals(Marking_size_0_25inch))
            {
                ...
                val_HEADER = MainCR0P25.getCRHEADER(PREIVIEW_STR_4_HEADER);
            ...
            }else if (size.Equals(Marking_size_0_19inch))
            {
                ...
                val_HEADER = MainCR0P190.getCRHEADER(PREIVIEW_STR_4_HEADER);
            ...
            }else if (size.Equals(Marking_size_0_125inch))
            {
                ...
                val_HEADER = MainCR0P125.getCRHEADER(PREIVIEW_STR_4_HEADER);
            ...
            }else if (size.Equals(Marking_size_0_090inch))
            {
                ...
                val_HEADER = MainCR0P090.getCRHEADER(PREIVIEW_STR_4_HEADER);
